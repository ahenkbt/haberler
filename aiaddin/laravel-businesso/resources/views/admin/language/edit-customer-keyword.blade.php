      ...
      <div class="card">
        <div class="card-header">
          ...
          <a class="btn btn-info btn-sm float-right d-inline-block"
            href="{{ route('admin.language.index') . '?language=' . request('language') }}">
        ...
        <div class="card-body pt-5 pb-5" id="app">
          <div class="row">
            <div class="col-lg-12">
              <form method="post" action="{{ route('admin.language.updateCustomerKeyword', $la->id) }}"
                id="ajaxEditForm">
                @csrf
                <div class="row">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="ajaxForm" action="{{ route('admin.language_management.add_front_keyword') }}" method="POST">
            @csrf
            <div class="form-group">
              <label for="">{{ __('Keyword') }}*</label>
              <input type="text" class="form-control" name="front_keyword" placeholder="{{ __('Enter Keyword') }}">
