            ...
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                ...
                <div class="form-group">
                  ...
                  @endif
                  <div class="mt-2">
                    <small>{{__('Click on the dropdown sign to select a icon') . '.'}}</small>
                  </div>
                </div>
                <div class="form-group">
                  <label for="">{{__('URL')}} **</label>
                  <input type="text" class="form-control" name="url" value="" placeholder="{{__('Enter URL of social media account')}}">
                  @if ($errors->has('url'))
