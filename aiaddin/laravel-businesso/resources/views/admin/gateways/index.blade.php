            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <p class="text-warning"><strong>{{ __('Cron Job Command') }} :</strong> <br>
                  <code>curl -sS -H "X-Cron-Secret: {{ __('YOUR_CRON_SECRET_FROM_ENV') }}" {{ route('cron.check_payment') }}</code>
                </p>
                <strong class="text-warning">{{ __('Set the cron job following this video') }}: </strong>
                <a href="https://youtu.be/LRUGDOuMsSk"
                  target="_blank">https://youtu.be/LRUGDOuMsSk</a>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="form-group">
                  ...
                  @endif
                  <p class="mt-1 mb-0 text-warning">{{ __("You will get your 'API Endpoit' from PayTabs Dashboard") . '.'}} 
                  </p>
