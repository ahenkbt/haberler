        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card-title d-inline-block">{{ __('Testimonial Section Image') }}</div>
                        </div>
                ...
                <form action="{{ route('admin.testimonial.update.image') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6 offset-lg-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 showImage mb-3">
                                        <img src=" {{ !empty($bs->testimonial_image) ? asset('assets/front/img/testimonials/' . $bs->testimonial_image) : asset('assets/admin/img/noimage.jpg') }}"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="ajaxForm" class="modal-form" action="{{ route('admin.testimonial.store') }}"
                        method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="rating" max="5"
                                placeholder="{{ __('Enter Rating Number') }}">
                            <p id="errrating" class="mb-0 text-danger em"></p>
                            <p class="text-warning mb-0">
                                <small>{{ __('The max rating number should be 5') . '.' }}</small>
                            </p>
                        </div>
                        <div class="form-group">
