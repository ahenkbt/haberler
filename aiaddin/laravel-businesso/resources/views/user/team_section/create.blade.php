...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{ __('Add_Member') }}</h4>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-10">
              <div class="card-title">{{ __('Create_New_Member') }}</div>
            </div>
        ...
        <div class="card-body pt-5 pb-5">
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              <form id="memberForm" action="{{ route('user.team_section.store_member') }}" method="POST"
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="name" placeholder="{{ __('Enter_name') }}">
                  @if ($errors->has('name'))
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="rank" placeholder="{{ __('Enter_rank') }}">
                  @if ($errors->has('rank'))
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="twitter" placeholder="{{ __('Enter_twitter_url') }}">
