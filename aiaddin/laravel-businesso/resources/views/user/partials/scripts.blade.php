...
<script>
    let $delete_title = "{{ __('Are_you_sure?') }}";
    let $delete_subtitle =
        "{{ __('You_won_not_be_able_to_revert_this!') }}";
    let $delete_btntext = "{{ __('Yes_delete_it!') }}";
    let $cancel_btntext = "{{ __('Cancel') }}";
    let $Select_a_language = "{{ __('Select_a_language') }}";
    let $No_Category_Exist = "{{ __('No_Category_Exist') }}";
    let $Select_a_category = "{{ __('Select_a_category') }}";
</script>
