...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ __('New_Booking') }}</h4>
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="#">{{ __('Room_Bookings') }}</a>
            </li>
            <li class="separator">
                <i class="flaticon-right-arrow"></i>
            </li>
            <li class="nav-item">
                <a href="#">{{ __('New_Booking') }}</a>
            </li>
        </ul>
    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title d-inline-block">{{ __('Make_New_Booking') }}</div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>{{ __('Check_In_or_Out_Date') . '*' }}</label>
                                            <input type="text" class="form-control"
                                                placeholder="{{ __('Select_Dates') }}" id="date-range" name="dates"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>{{ __('Number_of_Nights') . '*' }}</label>
                                            <input type="text" class="form-control"
                                                placeholder="{{ __('Number_of_Nights') }}" id="night" name="nights"
                                                value="{{ old('nights') }}" readonly>
                                            @error('nights')
                                                <p class="mt-1 mb-0 ml-1 text-danger">{{ $message }}</p>
                                            @enderror
                                            <p class="text-warning mt-1 mb-0 ml-1">
                                                {{ __('Number_of_Nights_warning_text') }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>{{ __('Number_of_Guests') . '*' }}</label>
                                            <input type="number" class="form-control"
                                                placeholder="{{ __('Number_of_Guests') }}" name="guests"
                                                value="{{ old('guests') }}">
                                            @error('guests')
                                                <p class="mt-1 mb-0 ml-1 text-danger">{{ $message }}</p>
                                            @enderror
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="discount" value="0.00"
                                                id="discount" placeholder="{{ __('Enter_Discount_Amount') }}"
                                                oninput="applyDiscount()">
                                            <p class="text-warning mt-1 mb-0 ml-1">
                                                {{ __('Do_not_press_Enter_key') }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>{{ __('Total_Rent') . ' (' . $currencyInfo->base_currency_text . ')' }}</label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>{{ __('Customer_Full_Name') . '*' }}</label>
                                            <input type="text" class="form-control"
                                                placeholder="{{ __('Enter_Full_Name') }}" name="customer_name"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>{{ __('Customer_Phone_Number') . '*' }}</label>
                                            <input type="text" class="form-control"
                                                placeholder="{{ __('Enter_Phone_Number') }}" name="customer_phone"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>{{ __('Customer_Email') . '*' }}</label>
                                            <input type="email" class="form-control"
                                                placeholder="{{ __('Enter_Customer_Email') }}" name="customer_email"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="payment_status" class="form-control">
                                                <option selected disabled>{{ __('Select_Payment_Status') }}</option>
