...
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (count($coupons) == 0)
                                <h3 class="text-center mt-2">{{ __('NO_COUPON_FOUND') }}!
                                </h3>
                            @else
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form class="deleteform d-inline-block"
                                                            action="{{ route('user.rooms_management.delete_coupon', ['id' => $coupon->id]) }}"
                                                            method="post">
                                                            @csrf
    ...
    {{-- create modal --}}
    @includeIf('user.rooms.coupon.create_coupon')

    {{-- edit modal --}}
    @includeIf('user.rooms.coupon.edit_coupon')
@endsection
