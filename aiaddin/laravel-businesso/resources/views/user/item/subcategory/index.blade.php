...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{ __('Item_Subcategories') }}</h4>
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-4">
              <div class="card-title d-inline-block">{{ __('Subcategories') }}
              </div>
            </div>
            <div class="col-lg-3">
            ...
            <div class="col-lg-12">
              @if (count($itemsubcategories) == 0)
                <h3 class="text-center">
                  {{ __('NO_ITEM_SUBCATEGORY_FOUND') }}</h3>
              @else
        ...
        <div class="modal-body">
          <form id="ajaxForm" class="modal-form" enctype="multipart/form-data"
            ...
            <div class="form-group">
              ...
              <select id="language" name="user_language_id" class="form-control category_language">
