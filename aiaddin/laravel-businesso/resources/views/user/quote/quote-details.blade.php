<!-- Details Modal -->
<div class="modal fade" id="detailsModal{{ $quote->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-body">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8">{{ $quote->name }}</div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-8">{{ $quote->email }}</div>
                    </div>
                    <hr>
                                ...
                                @else
                                    @if (is_array($field))
                                        @if (array_key_exists('type', $field) && $field['type'] == 5)
                                            <a href="{{ asset('assets/front/files/' . $field['value']) }}"
                                                class="btn btn-primary btn-sm"
                                                download="{{ $key . '.zip' }}">{{ __('Download') }}</a>
                                        @else
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            @elseif ($quote->status == 1)
                                <span class="badge badge-secondary">{{ __('Processing') }}</span>
