...
<div class="tp-hero">
  <div class="tp-hero-w">
    <div>
      <div class="tp-eyebrow"><i class="fa fa-film" style="color:var(--altin2)"></i> TUKAV — Tarih</div>
      <h1 class="tp-h1">Videolar <em>Belgesel ve Arşiv</em></h1>
      <p class="tp-hdesc">Türk kültürü tarihi ve medeniyetine dair belgeseller ve arşiv görüntüleri.</p>
    </div>
  </div>
</div>
<div class="tp-bc"><div class="tp-bc-w"><a href="<?php echo esc_url(home_url('/')); ?>">Ana Sayfa</a><span class="sep">›</span><a href="<?php echo esc_url(home_url('/tarih')); ?>">Tarih</a><span class="sep">›</span><span>Videolar</span></div></div>
...
<div class="tp-blog-sec"><div class="tp-blog-sec-w">
  <div class="tp-blog-hd"><div class="tp-blog-hd-bar"></div><h3>Videolar Yazilari</h3></div>
  <?php  ?>
</div></div>
<?php else: ?>
<div class="tp-sec"><div class="tp-sec-w">
  <div class="tp-sec-hd"><div class="tp-badge tq">Yazilar</div><h2 class="tp-sec-title">Videolar</h2><p class="tp-sec-sub">Türk kültürü tarihi ve medeniyetine dair belgeseller ve arşiv görüntüleri.</p></div>
...
<?php endif; ?>
<div class="tp-quote-band"><div class="tp-quote-band-w"><div class="tp-q-text">&quot;Geçmişi görüntüleyen geleceği aydınlatır.&quot;</div><div class="tp-q-src">— TUKAV</div></div></div>
