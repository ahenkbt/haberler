...
<div class="tp-hero">
  <div class="tp-hero-w">
    <div>
      <div class="tp-eyebrow"><i class="fa fa-award" style="color:var(--altin2)"></i> Tarih</div>
      <h1 class="tp-h1">Kahramanlar <em>Vatan İçin Mücadele</em></h1>
      <p class="tp-hdesc">Türk tarihinde vatan için savaşan kahramanların destanları.</p>
    </div>
  </div>
</div>
<div class="tp-bc"><div class="tp-bc-w"><a href="<?php echo esc_url(home_url('/')); ?>">Ana Sayfa</a><span class="sep">›</span><a href="<?php echo esc_url(home_url('/tarih')); ?>">Tarih</a><span class="sep">›</span><span>Kahramanlar</span></div></div>
...
<div class="tp-blog-sec"><div class="tp-blog-sec-w">
  <div class="tp-blog-hd"><div class="tp-blog-hd-bar"></div><h3>Kahramanlar Yazilari</h3></div>
  <?php  ?>
</div></div>
<?php else: ?>
<div class="tp-sec"><div class="tp-sec-w">
  <div class="tp-sec-hd"><div class="tp-badge tq">Yazilar</div><h2 class="tp-sec-title">Kahramanlar</h2><p class="tp-sec-sub">Türk tarihinde vatan için savaşan kahramanların destanları.</p></div>
...
<?php endif; ?>
<div class="tp-quote-band"><div class="tp-quote-band-w"><div class="tp-q-text">&quot;Kahraman ölmez vatan bölünmez.&quot;</div><div class="tp-q-src">— Vakıf</div></div></div>
