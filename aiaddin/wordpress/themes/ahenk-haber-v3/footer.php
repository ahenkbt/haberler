<?php
/**
 * Ahenk Haber v3 - Footer (Birportal sosyal bar dahil)
 */
?>
...
<!-- BİRPORTAL SOSYAL BAR -->
<?php
$fb  = get_theme_mod('ahenk_facebook','');
$tw  = get_theme_mod('ahenk_twitter','');
$yt  = get_theme_mod('ahenk_youtube','');
$ig  = get_theme_mod('ahenk_instagram','');
$tg  = get_theme_mod('ahenk_telegram','');
$target = get_theme_mod('ahenk_footer_sosyal_hedef','1') ? 'target="_blank" rel="nofollow noopener"' : '';
$fbar_baslik = get_theme_mod('ahenk_footer_sosyal_baslik','Bizi Takip Edin');
if ($fb || $tw || $yt || $ig || $tg) :
?>
<div class="footer-sosyal-bar">
  <div class="container">
    <div class="fsb-ic">
      <div class="fsb-baslik"><strong><?php echo esc_html($fbar_baslik); ?></strong></div>
      <ul class="fsb-liste">
        <?php if($fb):?><li><a href="<?php echo esc_url($fb); ?>" class="fsb-fb" <?php echo $target;?>><i class="fab fa-facebook-f"></i>FACEBOOK</a></li><?php endif;?>
        <?php if($tw):?><li><a href="<?php echo esc_url($tw); ?>" class="fsb-tw" <?php echo $target;?>><i class="fab fa-x-twitter"></i>X / TWİTTER</a></li><?php endif;?>
        <?php if($yt):?><li><a href="<?php echo esc_url($yt); ?>" class="fsb-yt" <?php echo $target;?>><i class="fab fa-youtube"></i>YOUTUBE</a></li><?php endif;?>
        <?php if($ig):?><li><a href="<?php echo esc_url($ig); ?>" class="fsb-ins" <?php echo $target;?>><i class="fab fa-instagram"></i>İNSTAGRAM</a></li><?php endif;?>
        <?php if($tg):?><li><a href="<?php echo esc_url($tg); ?>" class="fsb-tg" <?php echo $target;?>><i class="fab fa-telegram"></i>TELEGRAM</a></li><?php endif;?>
        <li><a href="<?php echo esc_url(get_page_link(get_page_by_path('iletisim'))); ?>" class="fsb-ilt"><i class="fa fa-envelope"></i>İLETİŞİM</a></li>
      </ul>
    </div>
  </div>
</div>
