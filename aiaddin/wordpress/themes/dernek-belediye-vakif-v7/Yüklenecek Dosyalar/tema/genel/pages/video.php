...
<section class="page-section">
	<div class="bg-white">
		<div class="col-12 p-0 banner">
			<img src="<?php echo tema;?>/uploads/arkaplan/arkaplan15/<?php echo $arkaplan['arkaplan15'];?>" alt="<?php echo $Sonuc['adi'];?>">
			...
			<div class="row">
				...
				<div class="col-lg-<?php echo($moduller['alan23'] == "1" ? '9' : '12');?> col-md-<?php echo($moduller['alan23'] == "1" ? '7' : '12');?> z-index-9">
					<div class="page-content">
						...
						<iframe style="width:100%;height:500px;" src="https://www.youtube.com/embed/<?php echo $Sonuc['kod']; ?>?rel=0&amp;autoplay=1" frameborder="0" allowfullscreen=""></iframe>
						...
						<div class="row py-4 haber-detay-box">
							<div class="col-12 mt-4">
								...
								<div class="ordered-list">
									<ul>
									<?php $DIGERSorgu = $db->prepare("SELECT * FROM video_galeri WHERE durum = ? AND dil = ? ORDER BY id DESC LIMIT 10");
									...
									$DIGERislem = $DIGERSorgu->fetchALL(PDO::FETCH_ASSOC);?>
										...
										<li class="is-active" id="<?php echo $DIGERSonuc['id']; ?>">
											<a href="<?php echo $htc['videodetayurl']; ?>/<?php echo $DIGERSonuc['seo']; ?><?php echo $html;?>">
												<h3 class="text">
									...
									<?php $kayit	= $db->query("SELECT * FROM  video_galeri WHERE durum = '1' AND dil = '{$_SESSION['k_dil']}'")->rowCount();?>
									<?php if($kayit > 10){?>
									<div class="more daha">
...
$(function(){
	$(".daha").click(function(){
		...
		$.ajax({
			type:"POST",
			url: "<?php echo tema;?>/ajax/diger_videolar.php",
			data: {"id":id},
