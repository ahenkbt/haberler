...
{
	$Sorgu = $db->prepare("SELECT * FROM birimler WHERE seo = ? AND durum = ? AND dil = ?");
...
{
	$Sorgu = $db->prepare("SELECT * FROM birimler WHERE durum = ? AND dil = ? ORDER BY id ASC");
...
$menubul 	= $db->query("SELECT * FROM menu WHERE menu_url = '".$htc['birimdetayurl']."/".$Sonuc['seo']."' OR link = '".$htc['birimdetayurl']."/".$Sonuc['seo']."' AND dil = '{$_SESSION['k_dil']}'")->fetch(PDO::FETCH_ASSOC);
...
<section class="page-section">
	<div class="bg-white">
		<div class="col-12 p-0 banner">
			<img src="<?php echo tema;?>/uploads/arkaplan/arkaplan17/<?php echo $arkaplan['arkaplan17'];?>" alt="<?php echo $Sonuc['adi'];?>">
				...
				<div class="col-lg-<?php echo($moduller['alan23'] == "1" ? '9' : '12');?> col-md-<?php echo($moduller['alan23'] == "1" ? '7' : '12');?> z-index-9">
					<div class="page-content">
						...
						<div class="row haber-detay-box">
							<div class="col-lg-12">
								<?php if($Sonuc['resim'] != ""){?>
								<img src="<?php echo tema;?>/uploads/birimler/<?php echo $Sonuc['resim'];?>" class="haber-detay-image">
								<?php }?>
								<div class="detay">
