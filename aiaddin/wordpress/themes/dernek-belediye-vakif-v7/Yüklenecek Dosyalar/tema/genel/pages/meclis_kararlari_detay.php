...
{
	$DETAYSorgu = $db->prepare("SELECT * FROM meclis_kararlari WHERE seo = ? AND dil = ?");
...
{
	$DETAYSorgu = $db->prepare("SELECT * FROM meclis_kararlari WHERE dil = ? ORDER BY id ASC");
...
<section class="page-section">
	<div class="bg-white">
		<div class="col-12 p-0 banner">
			<img src="<?php echo tema;?>/uploads/arkaplan/arkaplan7/<?php echo $arkaplan['arkaplan7'];?>" alt="<?php echo $DETAYSonuc['adi'];?>">
					...
					<div class="page-content">
						...
						<div class="row py-2 haber-detay-box">
							...
							<div class="col-lg-12">
								...
								<img src="<?php echo tema;?>/uploads/meclis_kararlari/<?php echo $DETAYSonuc['resim'];?>" class="haber-detay-image">
								<?php }?>
								<div class="detay">
								...
								<div class="documents-files documents-icon">
									<ul>
										<li>
											<a class="row no-gutters" target="_blank" href="<?php echo tema;?>/uploads/meclis_kararlari/dosya/<?php echo $DETAYSonuc['dosya'];?>" data-documents-src="">
