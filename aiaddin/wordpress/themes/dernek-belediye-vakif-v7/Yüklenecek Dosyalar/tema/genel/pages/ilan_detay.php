...
{
	$DETAYSorgu = $db->prepare("SELECT * FROM ilanlar WHERE seo = ? AND dil = ?");
...
{
	$DETAYSorgu = $db->prepare("SELECT * FROM ilanlar WHERE dil = ? ORDER BY id ASC");
...
<section class="page-section">
	<div class="bg-white">
		<div class="col-12 p-0 banner">
			<img src="<?php echo tema;?>/uploads/arkaplan/arkaplan12/<?php echo $arkaplan['arkaplan12'];?>" alt="<?php echo $DETAYSonuc['adi'];?>">
					...
					<div class="page-content">
						<h2 class="page-title">
							...
							<span class="tarih">
								...
								<?php echo tarih($DETAYSonuc['tarih']);?>
							</span>
						</h2>
						<div class="row py-2 haber-detay-box">
							...
							<div class="col-lg-12">
								...
								<img src="<?php echo tema;?>/uploads/ilanlar/<?php echo $DETAYSonuc['resim'];?>" class="haber-detay-image">
								<?php }?>
								<div class="detay">
							...
							<div class="col-12 mt-4">
								...
								<div class="ordered-list">
									<ul>
									<?php $DIGERSorgu = $db->prepare("SELECT * FROM ilanlar WHERE durum = ? AND dil = ? ORDER BY id DESC LIMIT 10");
									...
									$DIGERislem = $DIGERSorgu->fetchALL(PDO::FETCH_ASSOC);?>
										...
										<li class="is-active" id="<?php echo $DIGERSonuc['id']; ?>">
											<a href="<?php echo $htc['ilandetayurl']; ?>/<?php echo $DIGERSonuc['seo']; ?><?php echo $html;?>">
												<h3 class="text">
									...
									<?php $kayit	= $db->query("SELECT * FROM  ilanlar WHERE durum = '1' AND dil = '{$_SESSION['k_dil']}'")->rowCount();?>
									<?php if($kayit > 10){?>
									<div class="more daha">
...
$(function(){
	$(".daha").click(function(){
		...
		$.ajax({
			type:"POST",
			url: "<?php echo tema;?>/ajax/diger_ilanlar.php",
			data: {"id":id},
