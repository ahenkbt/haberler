...
if(strip_tags(isset($_GET['id'])))
{
	...
	if($DETAYSorgu->rowCount())
	{
		...
		$kategori 	=$db->query("SELECT * FROM haber_kategori WHERE durum = '1' AND id = '{$DETAYSonuc['kategori']}' AND dil = '{$_SESSION['k_dil']}'")->fetch(PDO::FETCH_ASSOC);
	}
	else
	{
...
<section class="page-section">
	<div class="bg-white">
		<div class="col-12 p-0 banner">
			<img src="<?php echo tema;?>/uploads/arkaplan/arkaplan19/<?php echo $arkaplan['arkaplan19'];?>" alt="<?php echo $DETAYSonuc['adi'];?>">
			...
			<div class="row">
				<div class="col-lg-<?php echo($moduller['alan23'] == "1" ? '9 offset-lg-3' : '12');?> col-md-<?php echo($moduller['alan23'] == "1" ? '7 offset-md-5' : '12');?> z-index-9">
					<ol class="breadcrumb z-index-9">
						...
						<li><a href="<?php echo $htc['haberkategoriurl'];?>/<?php echo $kategori['seo'];?><?php echo $html;?>"><?php echo ilkbuyuk($kategori['adi']);?></a></li>
					...
					<div class="page-content">
						...
						<div class="row py-4 haber-detay-box">
							...
							<div class="col-lg-12">
								...
								<img src="<?php echo tema;?>/uploads/haberler/<?php echo $DETAYSonuc['resim'];?>" onerror="imgError(this);" class="haber-detay-image">
								<?php }?>
								<div class="detay">
							...
							<div class="page-content-gallery gallery list margin-top-50">
								<div class="col-lg-12">
									<h2 class="page-title"><?=@$dil['txt153'];?></h2>
								</div>	
								<ul class="row margin-top-30 haberfoto">
									<?php foreach ( $Iislem as $ISonuc ){?>
									<li class="gallery-card col-sm-6 col-md-4 col-lg-3 col-6">
										<a href="<?php echo tema;?>/uploads/haberler/fotogaleri/<?php echo $ISonuc['resim']; ?>" data-fancybox="gallery" rel="group">
											<div class="gallery-photo"><img src="<?php echo tema;?>/uploads/haberler/fotogaleri/<?php echo $ISonuc['resim']; ?>"></div>
							...
							<div class="col-12 mt-4">
								...
								<div class="ordered-list">
									<ul>
									<?php $DIGERSorgu = $db->prepare("SELECT * FROM haberler WHERE durum = ? AND dil = ? ORDER BY id DESC LIMIT 10");
									...
									$DIGERislem = $DIGERSorgu->fetchALL(PDO::FETCH_ASSOC);?>
										...
										<li class="is-active" id="<?php echo $DIGERSonuc['id']; ?>">
											<a href="<?php echo $htc['haberdetayurl']; ?>/<?php echo $DIGERSonuc['seo']; ?><?php echo $html;?>">
												<h3 class="text">
									...
									<?php $kayit	= $db->query("SELECT * FROM  haberler WHERE durum = '1' AND dil = '{$_SESSION['k_dil']}'")->rowCount();?>
									<?php if($kayit > 10){?>
									<div class="more daha">
...
$(function(){
	$(".daha").click(function(){
		...
		$.ajax({
			type:"POST",
			url: "<?php echo tema;?>/ajax/diger_haberler.php",
			data: {"id":id},
