...
/**
 * Eski tek seferlik AHG SHA silmesi. SHA haberleri tekrar ASG+AHG’de isteniyor — no-op.
 */
export async function purgeAhgRssCampaignNewsOnNeon(_env) {
  return { ok: true, action: "disabled", reason: "sha-content-wanted-on-ahg-asg" };
}
