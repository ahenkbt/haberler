 ...
 * Seeds all 12 default platform UI languages with complete translations.
...
const platformDefaultLocale = (
  process.env.PLATFORM_DEFAULT_LOCALE ||
...
const PLATFORM_LANGUAGES: LanguageConfig[] = [
  { code: 'en', name: 'English', nativeName: 'English', flag: '🇺🇸', direction: 'ltr', isDefault: platformDefaultLocale === 'en', sortOrder: 0 },
  ...
  { code: 'tr', name: 'Turkish', nativeName: 'Türkçe', flag: '🇹🇷', direction: 'ltr', isDefault: platformDefaultLocale === 'tr', sortOrder: 11 },
];
