...
This document provides comprehensive technical documentation for developers integrating with the AgentLabs REST API.
...
The REST API Plugin provides a comprehensive API for external system integration with AgentLabs. It enables clients to programmatically:
...
└── docs/
    ...
    └── AgentLabs-API.postman_collection.json
```
