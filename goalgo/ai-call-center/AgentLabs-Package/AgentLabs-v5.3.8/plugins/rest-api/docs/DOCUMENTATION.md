...
**Author:** AgentLabs  
**License:** Commercial  
**Compatibility:** AgentLabs >=1.0.0, Node.js >=18.0.0
...
The REST API Plugin provides a comprehensive RESTful interface for external system integration with AgentLabs. It enables clients to programmatically:
...
AgentLabs supports three telephony engines for different use cases:
...
- AgentLabs v1.0.0 or higher running
- PostgreSQL 14+ database configured
- Admin access to your AgentLabs installation

### Step 1: Copy Plugin Files

Copy the `rest-api` folder to your AgentLabs plugins directory:

```bash
cp -r /path/to/rest-api agentlabs/plugins/
```
...
- **Prefix**: `agl_sk_` (AgentLabs Secret Key)
...
1. Log in to AgentLabs as a user
  ...
  "data": [
    {
      ...
      "url": "https://your-server.com/webhooks/agentlabs",
...
The plugin uses standard AgentLabs environment configuration. No additional environment variables are required.
...
```
plugins/rest-api/docs/AgentLabs-API.postman_collection.json
```
...
- **Email**: support@agentlabs.io

---

*REST API Plugin v1.0.0 - AgentLabs*
