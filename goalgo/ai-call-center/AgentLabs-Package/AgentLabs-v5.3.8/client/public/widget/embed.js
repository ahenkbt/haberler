(function() {
  ...
  var translations = {
    ...
    tr: { voiceChat: 'SESli GÖRÜŞME', connecting: 'Bağlanıyor...', callEnded: 'Görüşme sona erdi', poweredBy: '', terms: 'Şartlar ve koşullar', termsAgree: 'Kabul ediyorum', cancel: 'İptal', continue: 'Devam' }
  };
  ...
  async function initWebRTC(ephemeralKey, realtimeModel) {
    ...
    var sdpResponse = await fetch('https://api.openai.com/v1/realtime?model=' + encodeURIComponent(realtimeModel), {
      method: 'POST',
      headers: {
