...
const flagSvgs: Record<string, JSX.Element> = {
  ...
  tr: (
    <svg viewBox="0 0 512 512" className="w-full h-full">
      <mask id="tr_mask_landing"><circle cx="256" cy="256" r="256" fill="#fff"/></mask>
      <g mask="url(#tr_mask_landing)">
        <path fill="#d80027" d="M0 0h512v512H0z"/>
        <circle fill="#eee" cx="220" cy="256" r="96"/>
        <circle fill="#d80027" cx="248" cy="256" r="80"/>
        <path fill="#eee" d="M340 200l12 36h38l-31 23 12 36-31-23-31 23 12-36-31-23h38z"/>
      </g>
    </svg>
  ),
};
