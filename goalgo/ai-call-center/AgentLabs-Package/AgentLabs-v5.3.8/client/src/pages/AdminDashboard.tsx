  ...
  return (
    <div className="p-4 md:p-8 space-y-6 md:space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl md:text-4xl font-bold">{t("admin.dashboard.title")}</h1>
        ...
        <div className="flex items-center gap-2 md:gap-3 flex-wrap">
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <span className={`text-[10px] ${
                    ...
                    {twilioStatus?.connected ? t("admin.dashboard.connection.connected") : t("admin.dashboard.connection.notConnected")}
                  </span>
                </div>
              </div>
                  ...
                  <span className={`text-[10px] ${
                    ...
                    {elevenLabsStatus?.connected 
                      ? elevenLabsStatus.voiceCount !== undefined 
                        ? t("admin.dashboard.connection.voices", { count: elevenLabsStatus.voiceCount })
                        : t("admin.dashboard.connection.connected")
                      : t("admin.dashboard.connection.notConnected")}
                  </span>
                </div>
              </div>
                  ...
                  <span className={`text-[10px] ${
                    ...
                    {openaiStatus?.connected 
                      ? (openaiStatus as any).modelCount !== undefined 
                        ? t("admin.dashboard.connection.models", { count: (openaiStatus as any).modelCount })
                        : t("admin.dashboard.connection.connected")
                      : t("admin.dashboard.connection.notConnected")}
                  </span>
                </div>
                  ...
                  <span className={`text-[10px] ${
                    ...
                    {openaiRealtimeStatus?.connected 
                      ? (openaiRealtimeStatus as any).keyCount !== undefined 
                        ? t("admin.dashboard.connection.keys", { count: (openaiRealtimeStatus as any).keyCount })
                        : t("admin.dashboard.connection.connected")
                      : t("admin.dashboard.connection.notConnected")}
                  </span>
                </div>
              ...
              <div 
                ...
                title={t("admin.dashboard.connection.appVersion")}
              >
                ...
                <div className="flex flex-col">
                  <span className="text-xs font-medium text-blue-700 dark:text-blue-400">
                    {t("admin.dashboard.connection.version")}
                  </span>
              ...
              <Button 
                ...
                title={checkingStatus ? t("admin.dashboard.connection.refreshing") : t("admin.dashboard.connection.refreshStatus")}
        ...
        <div className="relative flex items-center -mx-4 md:-mx-8">
          ...
          >
            ...
            <TabsTrigger value="analytics" className="text-xs md:text-sm whitespace-nowrap" data-testid="tab-analytics">
              ...
              <span className="hidden sm:inline">{t("admin.dashboard.tabs.analytics")}</span>
              <span className="sm:hidden">{t("admin.dashboard.tabs.analyticsShort")}</span>
            </TabsTrigger>
            ...
            <TabsTrigger value="billing" className="text-xs md:text-sm whitespace-nowrap" data-testid="tab-billing">
              ...
              {t("admin.dashboard.tabs.billing")}
            </TabsTrigger>
            ...
            <TabsTrigger value="queue" className="text-xs md:text-sm whitespace-nowrap" data-testid="tab-batch-jobs">
              ...
              <span className="hidden sm:inline">{t("admin.dashboard.tabs.batchJobs")}</span>
              <span className="sm:hidden">{t("admin.dashboard.tabs.batchJobsShort")}</span>
            </TabsTrigger>
            <TabsTrigger value="calls" className="text-xs md:text-sm whitespace-nowrap" data-testid="tab-calls">
              ...
              <span className="hidden sm:inline">{t("admin.dashboard.tabs.callMonitoring")}</span>
              <span className="sm:hidden">{t("admin.dashboard.tabs.callsShort")}</span>
            </TabsTrigger>
            <TabsTrigger value="communications" className="text-xs md:text-sm whitespace-nowrap" data-testid="tab-communications">
              ...
              <span className="hidden sm:inline">{t("admin.dashboard.tabs.communications")}</span>
              <span className="sm:hidden">{t("admin.dashboard.tabs.commsShort")}</span>
            </TabsTrigger>
            <TabsTrigger value="voice-ai" className="text-xs md:text-sm whitespace-nowrap" data-testid="tab-voice-ai">
              ...
              <span className="hidden sm:inline">{t("admin.dashboard.tabs.voiceAi")}</span>
              <span className="sm:hidden">{t("admin.dashboard.tabs.voiceShort")}</span>
            </TabsTrigger>
