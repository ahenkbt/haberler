...
const RSS_TO_SITE_CATEGORY: Record<string, string> = {
  ...
  asayis: "asayis",
  ankara: "ankara",
  "ankara-haberleri": "ankara",
  "ankahaber-gundem": "ankara",
  yerel: "yerel",
  "yerel-haber": "yerel",
  kirsehir: "yerel",
  kirsehri: "yerel",
...
const ALIAS_GROUPS: string[][] = [
  ["gundem", "sondakika", "son-dakika", "turkiye", "turkey", "genel", "guncel", "diger", "haber"],
  ["dunya", "world", "avrupa"],
  ["ekonomi", "para", "ntvpara", "ntv-para", "economy"],
  ["politika", "siyaset"],
  ["spor", "sport", "sporskor", "spor-skor"],
  ["teknoloji", "technology", "teknoloji-ve-bilim", "teknolojivebilim", "bilim", "bilisim"],
  ["egitim", "education"],
  ["saglik", "health"],
  ["yasam", "life", "kultur", "kultur-sanat", "hayat", "cevre"],
  ["otomobil", "auto"],
  ["magazin"],
  ["asayis"],
  ["yerel", "yerel-haber", "kirsehir", "kirsehri", "yozgat", "ilcelerden", "yurt"],
  ["ankara", "ankara-haberleri", "ankahaber-gundem"],
