/** YouTube /podcasts sekmesinden gelen ama video oynatma listesi olan başlıklar */
...
/** Gerçek podcast / sesli içerik başlık ipuçları */
...
/** Sesli Günlük listesinde gösterilecek kaynak */
export function isPodcastSourceForDisplay(source: { sourceType: string; name: string }): boolean {
