 ...
 * ASCII slug'lar (Seri_penalti_vuruslari) için Türkçe karakter varyantları üretir.
 */
...
/** Tek kelime için ASCII→Türkçe adaylar (suffix + sözlük). */
...
/**
 * Slug veya ham başlıktan sıralı Vikipedi başlık adayları.
 * Örn. Seri_penalti_vuruslari → ["Seri penalti vuruslari", "Seri penaltı vuruşları", …]
 */
