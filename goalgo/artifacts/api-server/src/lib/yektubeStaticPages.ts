...
YekTube, Türkiye'nin ve Türk Dünyasının yerli ve milli arama motoru ve süper uygulaması (Super App) ekosistemi tarafından sağlanan yenilikçi bir video içerik platformudur. YekTube; yektube.com (kanonik alan; turk.eco/yp yönlendirilir) üzerinden bağımsız olarak hizmet verdiği gibi, aynı zamanda turk.eco/habermerkezi altyapısını kullanan ulusal ve yerel haber sitelerinin video/TV sayfalarından da yayın yapan entegre bir video portalı olarak faaliyet göstermektedir.
