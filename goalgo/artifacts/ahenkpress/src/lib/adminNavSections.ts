...
export const adminNavSections: AdminNavSection[] = [
  {
    ...
    items: [
      ...
      { name: "AHENK HABER (vitrin)", icon: SlidersHorizontal, href: "/admin/yekpare-haberler", permission: "haberler" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "AHENK HABER (vitrin)", icon: SlidersHorizontal, href: "/admin/yekpare-haberler", permission: "site_ayarlari" },
