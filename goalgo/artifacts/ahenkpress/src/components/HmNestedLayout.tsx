...
import { parseNewsSiteLayoutFromJson, normalizeHmVitrinTheme, isHmCorporateLikeTheme, resolveFinanceWeatherBelowMenu, resolveHeaderPreset, resolveHmNewsHeaderMenuEnabled, resolveHmNewsVideoTvEnabled, resolveShowYekpareIconMenu } from "@/lib/newsSiteLayout";
...
export function HmNestedLayout({
  ...
  const isCorporateTheme = isHmCorporateLikeTheme(layoutPrefs.hmVitrinTheme);
  ...
  const vitrinThemeAttr =
    ...
    layoutPrefs.hmVitrinTheme === "vatan"
